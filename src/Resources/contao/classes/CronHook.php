...
class CronHook extends \System
{
                    ...
                    if ($output!='')
                    {
                        \System::getContainer()
                            ...
                            ->log(LogLevel::ERROR,
                                ...
                                array('contao' => new ContaoContext('CronHook startJobs()', TL_ERROR)));
                    }
                    else
                    {
                        \System::getContainer()
                            ...
                            ->log(LogLevel::ERROR,
                                ...
                                array('contao' => new ContaoContext('CronHook startJobs()', TL_GENERAL)));
                    }
                } // if
            }
            else
     ...
     */
    private function runFileJob($strJob)
    {
        //File exists and readable?
        if (!is_readable(TL_ROOT . '/' . $strJob->job))
        {
    ...
    {
        if ('http:' == substr($strJob, 0, 5) || 'https:' == substr($strJob, 0, 5)) 
        {
