...
$GLOBALS['TL_LANG']['XPL']['cron_elements']['0']['1'] = 'The basic syntax for the time element is:<br/><br/><pre>n    begin[-end][/step]n</pre><br/>The parts enclosed in brackets are optional. The units dependend on the element type and can be minute, hour, day of month, day of week or month. The part <code>begin[-end]</code> may be replaced by a * which means <em>all</em>.<br/>For example, these are valid elements:<br/><br/><pre>n    5       minute,hour,day,... number 5n    3-5     minutes,hours,days,... 3,4,5n    5-10/2  minutes,hours,days,... 5,7,9n    *       all minutes,hours,days,...n    */3     minutes,hours,days,... 0,3,6,...n</pre>';
$GLOBALS['TL_LANG']['XPL']['cron_elements']['1']['0'] = 'Element list';
$GLOBALS['TL_LANG']['XPL']['cron_elements']['1']['1'] = 'Every part of the schedule can be entered as a comma separated list, for example:<br/><br/><pre>n   5,7,10-15/2,21  = Numbers 5,7,10,12,14,21n</pre>';
