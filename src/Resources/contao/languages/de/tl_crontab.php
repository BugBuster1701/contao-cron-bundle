...
$GLOBALS['TL_LANG']['tl_crontab']['curl_not_available']      = 'Die PHP cURL-Erweiterung ist nicht verfügbar.';
...
$GLOBALS['TL_LANG']['tl_crontab']['jobtype1']                = 'Datei';
$GLOBALS['TL_LANG']['tl_crontab']['jobtype2']                = 'Route';
$GLOBALS['TL_LANG']['tl_crontab']['jobtype3']                = 'URL';
$GLOBALS['TL_LANG']['tl_crontab']['jobtypetitle']            = 'Jobtyp';
...
$GLOBALS['TL_LANG']['tl_crontab']['one_is_necessary']        = 'Eins davon ist notwendig .';
...
$GLOBALS['TL_LANG']['tl_crontab']['t_dom']['1']              = 'Tage im Monat in Listenform. Zum Beispiel: 1,10,14-16,20. Ein * steht für jeden Tag.';
$GLOBALS['TL_LANG']['tl_crontab']['t_dow']['0']              = 'Wochentag';
$GLOBALS['TL_LANG']['tl_crontab']['t_dow']['1']              = 'Wochentage in Listenform entweder als Zahlen (0=Sonntag) zum Bsp: 0,2-4,7 oder englische Abkürzung zum Bsp: Sun,Tue-Thu,Sat. Ein * steht für jeden Wochentag.';
$GLOBALS['TL_LANG']['tl_crontab']['t_hour']['0']             = 'Stunde';
$GLOBALS['TL_LANG']['tl_crontab']['t_hour']['1']             = 'Stundenangabe in Listenform zum Beispiel 2,4,5-7,9. Um einen Job alle 3 Stunden auszuführen geben Sie */3 ein. Ein * steht für jede Stunde.';
$GLOBALS['TL_LANG']['tl_crontab']['t_minute']['0']           = 'Minute';
$GLOBALS['TL_LANG']['tl_crontab']['t_minute']['1']           = 'Minutenangabe in Listenform zum Beispiel 5,10,15-20,30. Um einen Job alle 15 Minuten auszuführen geben Sie */15 ein. Ein * steht für jede Minute.';
$GLOBALS['TL_LANG']['tl_crontab']['t_month']['0']            = 'Monat';
$GLOBALS['TL_LANG']['tl_crontab']['t_month']['1']            = 'Monate in Listenform als Zahl zum Bsp. 1,3,7-9, oder englische Abkürzung zum Bsp: Jan,Mar,Jul-Sep. Ein * steht für jeden Monat.';
