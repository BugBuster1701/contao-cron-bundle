...
$GLOBALS['TL_LANG']['tl_crontab']['t_minute']['1'] = "List the minutes for example as 5,10,15-20,30. Use the form */15 for example for every 15 minutes. Enter * for every minute.";
$GLOBALS['TL_LANG']['tl_crontab']['t_hour']['0']   = "Hour";
$GLOBALS['TL_LANG']['tl_crontab']['t_hour']['1']   = "List the hours for example as 2,4,5-7,9. Use the form */3 for example for every 3 hours. Enter * for every hour.";
$GLOBALS['TL_LANG']['tl_crontab']['t_dom']['0']    = "Day of month";
$GLOBALS['TL_LANG']['tl_crontab']['t_dom']['1']    = "List the days of month for example as 1,10,14-16,20. Enter * for all days.";
$GLOBALS['TL_LANG']['tl_crontab']['t_month']['0']  = "Month";
$GLOBALS['TL_LANG']['tl_crontab']['t_month']['1']  = "List the month numbers as 1,3,7-9, or name shortcuts as Jan,Mar,Jul-Sep for example. Enter * for every month.";
$GLOBALS['TL_LANG']['tl_crontab']['t_dow']['0']    = "Day of week";
$GLOBALS['TL_LANG']['tl_crontab']['t_dow']['1']    = "List the day numbers (0=sunday) as 0,2-4,7 or name shortcuts as Sun,Tue-Thu,Sat for example. Enter * for every day of week.";
